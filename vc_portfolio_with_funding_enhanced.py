...
class VCPortfolioWithFunding:
            ...
            if vc_name in vc_companies:
                ...
                for integrated_vc_name, companies in vc_companies.items():
                    if self.find_matching_vc(integrated_vc_name, [vc]):
                        ...
                        logger.info(f"Matched '{integrated_vc_name}' to '{vc_name}'")
                        break
    ...
    def save_to_json(self, filename='vc_portfolio_with_funding_enhanced.json'):
    ...
    def save_to_csv(self, filename='vc_portfolio_with_funding_enhanced.csv'):

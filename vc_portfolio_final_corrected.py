...
class VCPortfolioWithFunding:
    ...
    def load_vc_list(self, csv_file='Dissertation - VC list probided by startup db.csv'):
        ...
        try:
            ...
            for _, row in active_vcs.iterrows():
                # Fix: Use correct column for VC name (column 4, index 3)
    ...
    def save_to_json(self, filename='vc_portfolio_final_corrected.json'):
    ...
    def save_to_csv(self, filename='vc_portfolio_final_corrected.csv'):
